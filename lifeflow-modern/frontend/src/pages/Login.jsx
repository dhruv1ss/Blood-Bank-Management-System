    ...
    <div className="min-h-screen relative flex overflow-hidden font-['Inter','Outfit',sans-serif]" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      >
        <div className="absolute inset-x-0 bottom-0 p-12 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-20">
          <h2 className="text-4xl font-black text-white brand-font tracking-tight mb-4">Login Protocol</h2>
          <p className="text-white/60 font-bold uppercase tracking-widest text-xs">Secure authentication to the nexus network</p>
        </div>
        <img 
          src="/images/previews/login.png" 
