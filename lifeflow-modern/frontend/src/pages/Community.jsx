...
const Community = () => {
    ...
    return (
        <div className={`min-h-screen bg-[var(--bg-primary)] flex flex-col font-sans selection:bg-red-500/30 transition-colors duration-500`}>
            {/* News Detail Overlay */}
            <AnimatePresence>
                {selectedNews && (
                    <Motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className={`fixed inset-0 z-50 ${isDark ? 'bg-[var(--bg-primary)]/80' : 'bg-black/20'} backdrop-blur-xl flex items-center justify-end p-4 md:p-0`}
                    ...
                    >
                        <Motion.div
                            ...
                            className={`w-full max-w-xl h-full bg-[var(--bg-card)] border-[var(--border)] border-l shadow-[0_0_100px_rgba(0,0,0,0.3)] overflow-y-auto relative`}
                        ...
                        >
                            ...
                            <div className="p-10 pb-8 relative z-10">
                                <div className="flex items-start justify-between mb-8">
                                    ...
                                    <button onClick={() => setSelectedNews(null)} className={`text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] border-[var(--border)] transition-all p-2 rounded-xl border`}>
                                        <X className="w-6 h-6" />
                                    </button>
                                </div>
                                ...
                                <h2 className={`text-4xl font-black text-[var(--text-primary)] leading-[1.1] mb-6 brand-font tracking-tighter`}>{selectedNews.title}</h2>
                            ...
                            <div className="p-10 space-y-10 relative z-10">
                                {selectedNews.body.map((section, idx) => (
                                    ...
                                    >
                                        ...
                                        <p className={`text-[var(--text-secondary)] leading-relaxed font-medium text-[15px]`}>{section.text}</p>
                                    </Motion.div>
                                ))}
                            </div>
            ...
            <div className={`relative h-80 overflow-hidden bg-[var(--bg-card)] border-b border-[var(--border)]`}>
                ...
                <div className={`absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[var(--bg-primary)] to-transparent z-15`}></div>
            </div>
            ...
            <div className="container mx-auto px-4 lg:px-6 py-12 flex-grow flex flex-col lg:flex-row gap-8 lg:gap-12 relative z-20">
                ...
                <div className="lg:w-1/3">
                    <div className="sticky top-28 space-y-6">
                        <div className={`bg-[var(--bg-card)] border-[var(--border)] rounded-3xl p-7 border backdrop-blur-3xl shadow-2xl relative overflow-hidden group`}>
                            {/* Ambient glow */}
                            ...
                            <div className="space-y-6">
                                {MOCK_NEWS.map((news, i) => (
                                    <Motion.div 
                                        ...
                                        className={`group/item relative rounded-2xl p-4 transition-all hover:bg-[var(--bg-secondary)] border-transparent hover:border-[var(--border)] border cursor-pointer`}
                                    >
                                        <div className="flex gap-5">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className={`text-[11px] text-[var(--text-muted)] leading-relaxed font-medium line-clamp-2`}>{news.desc}</p>
                                            </div>
                                        </div>
                ...
                <div className="lg:w-2/3 max-w-3xl lg:max-w-none mx-auto w-full space-y-6">
                    ...
                    {isAuthenticated && (
                        <Motion.div 
                            ...
                            className={`bg-[var(--bg-card)] border-[var(--border)] rounded-[2.5rem] p-6 md:p-10 border backdrop-blur-3xl shadow-2xl relative overflow-hidden group`}
                        >
                                ...
                                <div className="flex gap-6 mb-8">
                                    ...
                                    <div className="flex-1 relative">
                                        <textarea 
                                            ...
                                            className={`w-full bg-[var(--bg-secondary)] border-[var(--border)] text-[var(--text-primary)] placeholder-[var(--text-muted)]/50 border rounded-2xl px-6 py-5 focus:outline-none focus:ring-4 focus:ring-red-500/10 focus:border-red-500/40 transition-all resize-none font-medium h-32 shadow-2xl`}
                                        />
                    ...
                    {isLoading ? (
                        ...
                        <div className={`bg-[var(--bg-card)] border-[var(--border)] rounded-[2rem] p-16 text-center shadow-lg border`}>
                            ...
                            <p className={`text-[var(--text-muted)] font-medium`}>Be the first to share your hero's journey.</p>
                        </div>
                    ) : (
                        <div className="space-y-6">
                            <AnimatePresence>
                                        ...
                                        <div className="flex items-center justify-between mb-8 relative z-10">
                                            <div className="flex items-center gap-5">
                                                ...
                                                <div>
                                                    ...
                                                    <p className={`text-[10px] text-[var(--text-muted)] font-bold flex items-center gap-3 uppercase tracking-widest`}>
                                                    ...
                                                    <div className="mt-8 pt-8 border-t border-[var(--border)] space-y-6">
                                                        {post.comments.map(comment => (
                                                            ...
                                                            >
                                                                ...
                                                                <div className={`bg-[var(--bg-secondary)] border-[var(--border)] border rounded-2xl rounded-tl-none p-4 px-5 w-full backdrop-blur-md relative group/comment`}>
                                                            ...
                                                            <form onSubmit={(e) => handleAddComment(e, post.id)} className="flex gap-4 mt-8 relative">
                                                                ...
                                                                <div className="flex-1 relative">
                                                                    <input 
                                                                        ...
                                                                        className={`w-full bg-[var(--bg-secondary)] border-[var(--border)] text-[var(--text-primary)] placeholder-[var(--text-muted)]/50 border rounded-xl px-6 py-3 focus:outline-none focus:ring-4 focus:ring-red-500/10 focus:border-red-500/40 transition-all font-medium text-sm shadow-2xl`}
                                                                    />
                                                                    <button 
                                                                        type="submit"
